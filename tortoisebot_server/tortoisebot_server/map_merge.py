                ...
                for i in range(og.info.width):
                    for j in range(og.info.height):
                        ...
                        if og.data[i + j * og.info.width] != -1:
                            new_map.data[int((i + og.info.origin.position.x - new_map.info.origin.position.x) + (j + og.info.origin.position.y - new_map.info.origin.position.y) * new_map.info.width)] = og.data[i + j * og.info.width]
                ...
                for i in range(self.complete_map.info.width):
                    for j in range(self.complete_map.info.height):
                        if self.complete_map.data[i + j * self.complete_map.info.width] != -1:
                            new_map.data[int((i + self.complete_map.info.origin.position.x - new_map.info.origin.position.x) + (j + self.complete_map.info.origin.position.y - new_map.info.origin.position.y) * new_map.info.width)] = self.complete_map.data[i + j * self.complete_map.info.width]
